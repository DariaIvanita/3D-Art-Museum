...
const images = {
    ...
    'ther prophet jeremiah.jpg',
    'the libyan sibyl.jpg',
    'the deluge.jpg',
    'the seperation of light and darkness',
    'the last6 judgement.jpg',
};

const year={
    'The Creation of Adam - 1511-1512',
    'The Last Judgment - 1536-1541',
    'The Prophet Jeremiah - 1511-1512',
    'The Deluge - 1508-1512',
    'The Seperation of Light from Darkness -1511',
}

const information={
 'The Creation of Adam (1511-1512):** A famous Sistine Chapel fresco capturing the moment God gives life to Adam, symbolizing the divine connection.',
'The Last Judgment (1536-1541):** A dramatic altar wall painting showing souls being judged by Christ, reflecting Michelangelo’s emotional turmoil.',
'The Prophet Jeremiah (1511):** A sorrowful portrait of Jeremiah, expressing the burden of his prophecies through raw body language.',
'The Libyan Sibyl (1511-1512):** Depicted mid-motion, her powerful yet graceful pose symbolizes wisdom and strength.',
'The Deluge (1508-1512):** A chaotic flood scene illustrating the fragility of life and nature’s force.',
'The Separation of Light from Darkness (1511):** God’s dynamic act of creation, vividly shown through motion and dramatic lighting.',
}:
...
document.getElementById('title').innerText = year[0;]
document.getElementById('artist').innerText = information[0];
