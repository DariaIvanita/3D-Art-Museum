export const paintingData = [
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    rotationY: Math.PI,
    info: {
      title: `The last judgement day ${i + 5}`,
      artist: 'Michea Angelo',
      description: `Artwork ${
        i + 5
      } by Micheal Angelo is an exceptional piece showcasing his remarkable ability to capture emotion and atmosphere.`,
      year: `Year ${i + 5}`,
      link: 'c:\Users\dasha\OneDrive\Pictures\the last judgement.jpg',
    },
  })),
  // Left Wall
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    rotationY: Math.PI / 2,
    info: {
      title: `Prophet Jeremiah  ${i + 9}`,
      artist: 'Micheal Angelo',
      description: `With its striking use of color and brushwork, Artwork ${
        i + 9
      } is a testament to Micheal Angelo's artistic genius.`,
      year: `Year ${i + 9}`,
      link: 'c:\Users\dasha\OneDrive\Pictures\the prophet jeremiah.jpg',
    },
  })),
  // Right Wall
  ...Array.from({ length: 4 }, (_, i) => ({
